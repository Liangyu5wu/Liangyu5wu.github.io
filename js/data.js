  ...
  publications: [
    {
      ...
      summary: "First fine-tuning of an industrial foundation model (Google Research\u2019s TimesFM) for particle physics DAQ, distilled into a compact student and co-designed with an FPGA implementation for real-time regression on drift chamber and dual-readout calorimeter data.",
      ...
      links: { pdf: "https://arxiv.org/pdf/2609.23385", external: "https://arxiv.org/abs/2609.23385" },
      project: "On-chip-ml",
      body: `This work connects the two extremes of AI/ML development for detector data acquisition: large-scale industrial foundation models on one end, and tiny on-detector deployments on the other. Starting from the backbone of Google Research\u2019s TimesFM time series foundation model, we perform the first fine-tuning of an industrial foundation model for particle physics DAQ, targeting real-time regression tasks in drift chamber trackers and dual-readout calorimeters. The fine-tuned teacher is then distilled into a compact student that is co-designed with its FPGA implementation, so the resulting model can actually run within the latency and resource budgets of a future collider front-end. The distilled models meet or exceed previously published AI/ML solutions for both tasks, and because the distillation and compression pipeline is agnostic to the underlying physics, it transfers readily to other 1D waveform problems inside and outside high energy physics.`,
    },
    {
      slug: "NEXUS_FM",
