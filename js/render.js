...
(function () {
  ...
  var ICONS = {
    ...
    orcid: '<svg viewBox="0 0 256 256" fill="currentColor"><path d="M128 0C57.3 0 0 57.3 0 128s57.3 128 128 128 128-57.3 128-128S198.7 0 128 0zM86.3 186.2H70.9V79.1h15.4v107.1zM78.6 65.5c-5.5 0-10-4.5-10-10s4.5-10 10-10 10 4.5 10 10-4.5 10-10 10zm107.4 120.7h-15.4v-52.4c0-15.6-6.3-21.3-14.3-21.3-8.6 0-15.9 6.5-15.9 21.6v52.1h-15.4V79.1h14.8v9.8h.2c2.9-5.5 10.2-11.3 21-11.3 15.7 0 25 10.3 25 31.5v77.1z"/></svg>',
